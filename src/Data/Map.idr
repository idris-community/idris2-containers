...
find :  Ord k
     ...
     -> v
find _ Tip              =
  assert_total $ idris_crash "Data.Map.find: given key is not an element in the map"
...
findIndex =
  ...
  where
    go :  Nat
       ...
       -> Nat
    go _   _ Tip              =
      assert_total $ idris_crash "Data.Map.findIndex: element is not in the map"
    go idx k (Bin _ kx _ l r) =
      case compare k kx of
        LT =>
          go idx k l
...
elemAt :  Nat
       ...
       -> (k, v)
elemAt _ Tip              =
  assert_total $ idris_crash "Data.Map.elemAt: index out of range"
...
updateAt f i t =
  case t of
    Tip             =>
      assert_total $ idris_crash "Data.Map.updateAt: index out of range"
    Bin sx kx x l r =>
      case compare i (size l) of
        LT =>
...
deleteAt i t =
  case t of
    Tip            =>
      assert_total $ idris_crash "Data.Map.deleteAt: index out of range"
    Bin _ kx x l r =>
      case compare i (size l) of
        LT =>
...
findMin t =
  case lookupMin t of
    Just r  =>
      r
    Nothing =>
      assert_total $ idris_crash "Data.Map.findMin: empty map has no minimal element"
...
findMax t =
  case lookupMax t of
    Just r  =>
      r
    Nothing =>
      assert_total $ idris_crash "Data.Map.findMax: empty map has no maximal element"
...
deleteFindMin t =
  case minViewWithKey t of
    Just res =>
      res
    Nothing  =>
      (assert_total $ idris_crash "Data.Map.deleteFindMin: can not return the minimal element of an empty map", Tip)

||| Retrieves the maximal (key,value) pair of the map, and
||| the map stripped of that element, or Nothing if passed an empty map. O(log n)
export
maxViewWithKey :  Map k v
               -> Maybe ((k, v), Map k v)
maxViewWithKey Tip             =
  Nothing
...
deleteFindMax t =
  case maxViewWithKey t of
    Just res =>
      res
    Nothing  =>
      (assert_total $ idris_crash "Data.Map.deleteFindMax: can not return the maximal element of an empty map", Tip)
